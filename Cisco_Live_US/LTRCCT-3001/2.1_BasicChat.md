...
-Continue by adding the `Email` field in the same manner with the info in this table.
...
- Go to WxCC admin Portal and Click on **_Provisioning_** and select **_Entry Points/Queues_** > **_Entry Point_**.
...
<img align="middle" src="images/Lab2_131313.jpg" width="1000" />
<br/>
<br/>
...
- Download the default **Inbound and Close Chat Flow**, please find the links below. Click on the arrow as shown in screenshot below.
...
- Enter the **FLOW NAME** as **Live Chat Inbound Flow**, select the **TYPE** as **Work Flow** and under **METHOD** select **Upload a flow** from the dropdown.
...
- Repeat these steps for closed flow as well. [Provide the name as 'chat Close flow']
...
<img align="middle" src="images/Lab2_36.png" width="600" />
<br/>
<br/>

- Fill in the form with customer options.

>**Note**: Please note down the name you provide here, we will use this to find transcript in the next lab.

<img align="middle" src="images/Lab2_37.png" width="600" />
<br/>
<br/>
...
<img align="middle" src="images/Lab2_39 copy.png" width="1000" />
<br/>
<br/>
...
<img align="middle" src="images/Lab2_39 copy_end.png" width="1000" />
<br/>
<br/>

- Select wrap up code of your choice and click submit wrap up to close chat session from agent desktop..
...
<script>
function mainPage() {window.location.href = "https://ciscolivelabs.github.io/wxcclabguides/Cisco_Live_US/LTRCCT-3001/1_PreReq.html";}
function nextLab() 
 {
 window.location.href = "https://ciscolivelabs.github.io/wxcclabguides/Cisco_Live_US/LTRCCT-3001/2.2_AdditionalCapabilities.html";;
 }
</script>
