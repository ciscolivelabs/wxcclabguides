...
<br>
<img align="middle" src="images/Lab8_3.png" width="700" />
<br>
...
- Download the sample CSV file from [GitHub](https://github.com/ciscolivelabs/wxcclabguides/blob/main/LTRCCT-3001/sample_corpus.csv?plain=1) [Refer to screenshot below]{:target="_blank"}**\
...
function nextLab() 
 {
 window.location.href = "https://ciscolivelabs.github.io/wxcclabguides/Cisco_Live_US/LTRCCT-3001/4.1_TaskBotSetup.html";
 }
</script>
