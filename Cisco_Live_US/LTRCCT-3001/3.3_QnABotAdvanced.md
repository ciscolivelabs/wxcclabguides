...
- Download the sample CSV file from [GitHub](https://github.com/ciscolivelabs/wxcclabguides/blob/main/LTRCCT-3001/sample_corpus.csv?plain=1) [Refer to screenshot below]
