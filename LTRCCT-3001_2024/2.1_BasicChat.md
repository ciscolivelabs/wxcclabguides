...
- Under **Customer Experience**, select **Channels**.
...
<img align="middle" src="images/New_Channel.jpg" width="1000" />
<br/>
<br/>
...
<img align="middle" src="images/New_Queue.jpg" width="1000" />
<br/>
<br/>
...
- Navigate to **Webex Connect Flows/v3.0/Template/Media Specific Workflows** -> click on **LiveChatInboundFlow.workflow.zip** and click download. 
...
- Repeat 1-6 steps to download and configure **Live Chat Close Workflow**
...
- Open a new tab in your browser and navigate to the Glitch website previously created, you copied the URL in previous step (it should be something ending on *.glitch.me).
