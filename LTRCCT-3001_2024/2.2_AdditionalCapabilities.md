...
2. You have successfully completed the previous **Lab 1.2 - Basic Chat configuration**
...
- In the Group Name field, enter the template group name with your **AttendeeID** and click `Add`
...
<img align="middle" src="images/NewTemplate.png" width="1000" />
<br/>
<br/>
...
- Now, start a new chat and receive the request in the Agent Desktop. In the interaction panel, you will see an Icon for Templates, click on it and select the Quick response that you want to use.

<img align="middle" src="images/QuickResponses.png" width="1000" />
<br/>
<br/>
...
<img align="middle" src="images/AU_Lab2_Step8_1.png" width="1000" />
<br/>
<br/>

- Search by Name and input the full name you used. Then, click on the Search button at the top left
...
<img align="middle" src="images/DecryptLogs.png" width="1000" />
<br/>
<br/>
...
function nextLab() 
 {
 window.location.href = "https://ciscolivelabs.github.io/wxcclabguides/LTRCCT-3001_2024/3.1_QnABotConfiguration.html";;
 }
</script>
...
<button onclick="nextLab()" style="
  border-radius: 5px;
  background-color: rgb(116,191,75);
  padding: 10px;">Go To Next Lab</button>
</div>